...
class UserSettingsModel(Base):
    ...
    preferred_model = Column(Enum(GeminiModel), nullable=False, default=GeminiModel.FLASH)
...
class DocumentModel(Base):
    ...
    summaries = relationship("SummaryModel", back_populates="document", cascade="all, delete-orphan")
    flashcards = relationship("FlashcardModel", back_populates="document", cascade="all, delete-orphan")
